About amptools-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/amptools-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2682&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/amptools-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `amptools` can be installed with `conda`:
...
```
mamba install amptools
```

It is possible to list all of the versions of `amptools` available on your platform with `conda`:
...
```
mamba search amptools --channel conda-forge
```
...
mamba repoquery search amptools --channel conda-forge

# List packages depending on `amptools`:
mamba repoquery whoneeds amptools --channel conda-forge

# List dependencies of `amptools`:
mamba repoquery depends amptools --channel conda-forge
```
